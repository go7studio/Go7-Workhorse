...
export const COMMANDS: Command[] = [
  ...
  { id: "settings", name: "/settings", hint: "Profile, connected LLMs, skills, workshop, bot knowledge, routing, learning, usage, watch", run: "settings", aliases: ["/config", "/preferences", "/prefs"] },
