...
* a judge scores each mission report's text, and never calls it verified ([#353](https://github.com/go7studio/Go7-Workhorse/issues/353)) ([fc8a9d5](https://github.com/go7studio/Go7-Workhorse/commit/fc8a9d58ca3aa77eadfb5ff3e630da245490ae1c))
...
* add persistent debug execution mode ([74c6280](https://github.com/go7studio/Go7-Workhorse/commit/74c62806f1352435c9b30fde1d86da77c0d84a5f))
* add persistent debug execution mode ([036c702](https://github.com/go7studio/Go7-Workhorse/commit/036c7024ee168be1e1fcebe7908ca1ad0a4b8706))
...
* Bot knowledge rubric, multi-domain view, 5-hour window holds, per-chat workshop packs ([8cdb81b](https://github.com/go7studio/Go7-Workhorse/commit/8cdb81b9ae9e8d1150d5ba01ea18e972427287a1))
* bots are scored out of 100 on a steep curve, with the Agent Arena mixed into every domain ([0516eac](https://github.com/go7studio/Go7-Workhorse/commit/0516eacf450f7f95afe9eaa85bc15c17f55f8fc1))
...
* orchestration grades bots strictly and weighs what each model's runs take from a plan ([0f87980](https://github.com/go7studio/Go7-Workhorse/commit/0f879801079b66f31b1f0d8e7e7fd32624e26535))
* orchestration prices each bot's typical run at its list input and output price and favours the cheaper ([2d96dcd](https://github.com/go7studio/Go7-Workhorse/commit/2d96dcda49b93e795bc9602b0eb0bc8b87c3438c))
* orchestration ranks spawns by domain benchmark, and Settings shows it as Bot knowledge ([f44102f](https://github.com/go7studio/Go7-Workhorse/commit/f44102f034ad048ca4318ecbfd54a9d4653ea3c1))
* orchestration reads public leaderboard scores and plan terms, and heads search the desk before staffing ([c5c7c58](https://github.com/go7studio/Go7-Workhorse/commit/c5c7c589f49e6645e8c96c59be05c65f5cce2d2a))
* Quick, Balanced and Deep weigh speed and usage, not only a quality bar ([df3da51](https://github.com/go7studio/Go7-Workhorse/commit/df3da51f412cfdbbc51699059faa414b480c91b9))
...
* /model grok-bot no longer launches the Grok CLI ([560fb6c](https://github.com/go7studio/Go7-Workhorse/commit/560fb6cdb76113e3aba6bc04d31ad114de10defc))
* a build from a shallow clone or source archive is not refused ([b843364](https://github.com/go7studio/Go7-Workhorse/commit/b8433649e67ce74a14cc7a9b6007964824ad6987))
* a change-list base that reads as a git option is refused ([b60e0b3](https://github.com/go7studio/Go7-Workhorse/commit/b60e0b3cafef89ab153c6feeaeb2217547e6e8f6))
...
* a Cursor chat's setup tide reads its own pool's plan ([c504c48](https://github.com/go7studio/Go7-Workhorse/commit/c504c48d5c8c618c6e73a15fbdaf75eac56fe8a2))
* a Cursor pool's usage drill-in lists only its own models ([ff93af8](https://github.com/go7studio/Go7-Workhorse/commit/ff93af860b38fb5768f423f2d48d813c83a41e44))
* a custom host on plain http lists its models ([de5069d](https://github.com/go7studio/Go7-Workhorse/commit/de5069dfbd8779806a885ae06574a44801e249bb))
* a custom key is never sent to a host a redirect names ([839054b](https://github.com/go7studio/Go7-Workhorse/commit/839054baa20bf6038233b30556b7536c3422f794))
* a custom probe and a stream error redact a key the host quotes back ([147b157](https://github.com/go7studio/Go7-Workhorse/commit/147b15767200acbdfe8b14948a711fbd1aa9560c))
* a custom tool refuses a link that points nowhere ([644c6d3](https://github.com/go7studio/Go7-Workhorse/commit/644c6d3998113c2512d33025790eb25864161445))
* a custom tool the role was not offered is refused, not run ([877474d](https://github.com/go7studio/Go7-Workhorse/commit/877474dde4337119012ce77a373b56d57388ad04))
...
* a dear bot's run cost keeps counting past a cheap baseline, and quick work pays for quality up to 4 ([af938de](https://github.com/go7studio/Go7-Workhorse/commit/af938deef9f5f98effff6e8953724fd49ad76d95))
* a denied tool call no longer marks the whole chat idle ([60430d4](https://github.com/go7studio/Go7-Workhorse/commit/60430d41bc731915f2315a789459c63cf50654c8))
* a desk answer is never sent again through the inbox ([c87fd8e](https://github.com/go7studio/Go7-Workhorse/commit/c87fd8e46870b7f453f75f749bbc030d2652d883))
...
* a desk that keeps changing is still saved every ten seconds ([5e639cc](https://github.com/go7studio/Go7-Workhorse/commit/5e639cc24f285cc114b7a49e1db191b66b66ab55))
* a development desk leaves the installed desk's Grok Bot keepalive alone ([6312326](https://github.com/go7studio/Go7-Workhorse/commit/6312326f10bdbbf3761ab0ad6090bb2da7019d65))
* a development desk refuses to install a release ([57c897e](https://github.com/go7studio/Go7-Workhorse/commit/57c897e8053503c9f90451750dad06e945c5847e))
* a file beside the worker folders is not taken for one ([939059e](https://github.com/go7studio/Go7-Workhorse/commit/939059e214b9f8834bda1fee3d81195ece82344c))
...
* a head's brief says to start every slice now, and to queue a dependent one with after ([ae14f57](https://github.com/go7studio/Go7-Workhorse/commit/ae14f574e0e764176480291b7c3c6b89dd6df658))
* a learning purge builds the new database before it touches the old one ([0b9e2bb](https://github.com/go7studio/Go7-Workhorse/commit/0b9e2bbec0dc87f9b8b52accd770d88b4ad29aa6))
* a learning purge no longer sends the compiler back to its first event ([8f3d53a](https://github.com/go7studio/Go7-Workhorse/commit/8f3d53ab33665aec2291b61ab03334a9ee33a0de))
* a learning store that will not open no longer leaves the desk windowless ([08b1a73](https://github.com/go7studio/Go7-Workhorse/commit/08b1a73af9b2ef7f9494567f1160916731a3fa88))
* a Link helper answers every request instead of dying on one ([04972e6](https://github.com/go7studio/Go7-Workhorse/commit/04972e66870dfb5a08e541447e748403abddde28))
* a link to docs.x.ai or grok.com stays a link instead of a broken image ([3d910aa](https://github.com/go7studio/Go7-Workhorse/commit/3d910aa0003179242f1bf83937c30a55b7980697))
* a link whose URL holds parentheses keeps its closing paren ([1bf1c17](https://github.com/go7studio/Go7-Workhorse/commit/1bf1c17a060e62e5f5fbfaaee6aa52134d9e7b05))
* a Mac update copies the new app beside the old one before swapping ([01cb74d](https://github.com/go7studio/Go7-Workhorse/commit/01cb74dd33320a24b151b4fd8381a5a1589e07e0))
* a missing picture no longer stats every Grok session folder ([e7b82f1](https://github.com/go7studio/Go7-Workhorse/commit/e7b82f1046b78ff61c4f7c3ce657ff0a816917c8))
* a picture path on another machine is never stat'ed or fetched ([68de9f4](https://github.com/go7studio/Go7-Workhorse/commit/68de9f40d4e674faca9d36ca20b438cf9014404f))
...
* a purge or forget during a compile keeps nothing the compile was told ([c408e54](https://github.com/go7studio/Go7-Workhorse/commit/c408e545d42e49affa592db32c13f3c7885e7e9b))
* a relaunch no longer folds a custom bot's chat into its last turn ([3fb0b46](https://github.com/go7studio/Go7-Workhorse/commit/3fb0b46d319bf5a5b13a4858c04cd73640ad7f90))
* a released worker folder goes in one rename, not a killable delete ([5848607](https://github.com/go7studio/Go7-Workhorse/commit/58486075bce15fe015e49ccfeecba5f259df592c))
* a renamed file keeps its new name in the chat's change list ([4a308c5](https://github.com/go7studio/Go7-Workhorse/commit/4a308c5d9e3686c6340e98a55b6e2483980c8fab))
* a reopened vendor session gets the chat's effort and model settings ([4460adb](https://github.com/go7studio/Go7-Workhorse/commit/4460adb214611ebf37372592689f2b69a7b4a384))
* a save is for changes, not for repaints ([#345](https://github.com/go7studio/Go7-Workhorse/issues/345)) ([e872b7b](https://github.com/go7studio/Go7-Workhorse/commit/e872b7b507838135e3b9245f9029adf012b5b0b2))
* a saved anthropic-messages dialect survives a reload ([b30617f](https://github.com/go7studio/Go7-Workhorse/commit/b30617f61b309b7f4a7422c8a300fdd3112c4ea2))
* a state file from a newer Workhorse is kept aside, never written over ([0735561](https://github.com/go7studio/Go7-Workhorse/commit/073556124b9ae0207a06d8e5739854d679a0be31))
* a status list that repeats a label keeps every row ([438fec6](https://github.com/go7studio/Go7-Workhorse/commit/438fec67e48ec670351a16281c945b7ec29e9729))
* a Stop pressed while a vendor starts keeps that prompt from running ([c5bdeb5](https://github.com/go7studio/Go7-Workhorse/commit/c5bdeb52f918d792df11365f331de9ad02b39f71))
* a streaming table rule row no longer freezes the renderer ([8d5942c](https://github.com/go7studio/Go7-Workhorse/commit/8d5942c120b1c07ec742ea34244cf05d67cf061d))
...
* a vendor's stderr is kept to a tail, and its exit denies open asks ([0aec3ca](https://github.com/go7studio/Go7-Workhorse/commit/0aec3ca9828e44455c01d08e66a7a56cdc869588))
* a worker folder ask waits for the one before it however that ended ([09f746b](https://github.com/go7studio/Go7-Workhorse/commit/09f746b62f19403d028c0dc03e1647bcb041e4ff))
* a worker folder from another repository is never handed back ([5a1beac](https://github.com/go7studio/Go7-Workhorse/commit/5a1beaccc6ab8a6a3afd4ffc47d22cf39f80a515))
* a worker folder goes only when its ignored files are shown to be a cache ([2a45d96](https://github.com/go7studio/Go7-Workhorse/commit/2a45d96334be2d61c3301aa40e700e1700cb9c62))
* a worker or auditor names no chat but its own ([55a768e](https://github.com/go7studio/Go7-Workhorse/commit/55a768e09f3a5a60966536b72917073a03c93d0d))
* a worker's earlier steps are never written over by a later offload ([37b897e](https://github.com/go7studio/Go7-Workhorse/commit/37b897ead3deec4ff19ff2e911bef2e79cd7a95b))
...
* admit only the auditor that saw the work, and stop re-spawning it ([3bcbaa5](https://github.com/go7studio/Go7-Workhorse/commit/3bcbaa52d75cc9a7fdfa417e0325315b582c3a6b))
* Allow on a vendor card grants the vendor that was asked for ([73fecef](https://github.com/go7studio/Go7-Workhorse/commit/73fecef39ea311ff849cd0d98ce81a5e6a17ec37))
...
* an exposed MCP tool name fits 64 characters ([bcc73dd](https://github.com/go7studio/Go7-Workhorse/commit/bcc73dddb633c6ad20295cb7f503f1c48dd63cbd))
* an inbox ask no longer carries its file id to the desk ([c00b6fd](https://github.com/go7studio/Go7-Workhorse/commit/c00b6fdd51c4495ab4e98f6ea4d39f19a8488433))
* an inbox request dies with its asker, and a quit desk reads offline ([1887da8](https://github.com/go7studio/Go7-Workhorse/commit/1887da80ed7aa45d94cdaff6845e7f2d499970c2))
* an MCP permission card shows the call's arguments ([5a37f28](https://github.com/go7studio/Go7-Workhorse/commit/5a37f280aeff2351e6dddc5c3f0c68391301f829))
...
* an old terminal shell's exit no longer ends the one that replaced it ([226024a](https://github.com/go7studio/Go7-Workhorse/commit/226024ae366ac70353a5f9c2eff355d08fa38f3d))
* an orchestrator checks the work before it reports, can queue a slice after another, and a long brief is not deep work ([f68dc10](https://github.com/go7studio/Go7-Workhorse/commit/f68dc10ae5dfc17e9711e87e314402f9f0c96cd1))
* an orchestrator reports who ran each slice, keeps its thinking between tool rounds, and names a slice's domain ([f45d743](https://github.com/go7studio/Go7-Workhorse/commit/f45d743ba3f7c575839b0950b80c9ad0b2b5037c))
* an unsupported ACP request is answered with an error and no result ([f8c6b75](https://github.com/go7studio/Go7-Workhorse/commit/f8c6b75b154a291e4349219578788cbc0a2fdb86))
...
* book each worker usage report against the committed run ([05e439d](https://github.com/go7studio/Go7-Workhorse/commit/05e439d35ea68f1068d2a00670a778b179dbdae2))
* bot setup counts a bot as listed only on the same endpoint ([2ff27d0](https://github.com/go7studio/Go7-Workhorse/commit/2ff27d0f1a802deb66edf265f4e3569e5454db8b))
* building a Cursor launch no longer runs the Cursor CLI on the main process ([e2c3202](https://github.com/go7studio/Go7-Workhorse/commit/e2c3202c9af6f78bcd85522eaaa9094bf472120c))
...
* **chat:** restore transcript scroll; Always skips path allowlist (0.6.91) ([acc789d](https://github.com/go7studio/Go7-Workhorse/commit/acc789da1fee8732d559573ba88e0e2e940f1a17))
...
* copying a code block keeps its first line's indentation ([44c8521](https://github.com/go7studio/Go7-Workhorse/commit/44c8521804d4cd9074e04ffa23c829ebad6aa6cc))
* custom tool text is cut between characters and decoded whole ([48fdbff](https://github.com/go7studio/Go7-Workhorse/commit/48fdbffd07b1fbaf03439cf02e54f6610e64831d))
...
* deleting a chat stops and removes everything it spawned ([a365d22](https://github.com/go7studio/Go7-Workhorse/commit/a365d22aa339bbeac301fb0a24a96e6166052e40))
...
* do not paint a red the-other-agent card for a nameless failed ask ([#339](https://github.com/go7studio/Go7-Workhorse/issues/339)) ([f7fab5b](https://github.com/go7studio/Go7-Workhorse/commit/f7fab5bb54f68b57155c6384a9696a6ddaeca245))
...
* full audit — permissions, read-only, Link, files and releases ([9c10f9d](https://github.com/go7studio/Go7-Workhorse/commit/9c10f9d3dd76188e1aabcc56232ef6ef1b0d9af6))
* gallery Open only opens a picture or video of the row's kind ([2e812cf](https://github.com/go7studio/Go7-Workhorse/commit/2e812cff002c16bfee043ae47d78b54c0fbd695c))
...
* give each ACP permission ask an id no other chat can hold ([dac0db9](https://github.com/go7studio/Go7-Workhorse/commit/dac0db9df3c81e65a441c4c194331eea3a00df27))
* grok-pending skips a request that vanished mid-listing ([5e8e9d9](https://github.com/go7studio/Go7-Workhorse/commit/5e8e9d9ce8f89a59618f7f6b6b3aa224d44da246))
* guard navigation in every window and trust only the app's own index ([841f427](https://github.com/go7studio/Go7-Workhorse/commit/841f42760dc1112b4734c9a0e987f0bd758db573))
* Hermes install writes its entry at the file's own indent ([1ddcb15](https://github.com/go7studio/Go7-Workhorse/commit/1ddcb15dd01d768e6f5ba6e564ad217ff8c97242))
...
* idle chats must not keep walking ([#329](https://github.com/go7studio/Go7-Workhorse/issues/329)) ([53696ef](https://github.com/go7studio/Go7-Workhorse/commit/53696ef4634003d9925b9f63343c1e67a6724789))
* install the IPC sender guard before the learning channels ([97dc8d5](https://github.com/go7studio/Go7-Workhorse/commit/97dc8d57287863d45b8c710d14a376cc2302253a))
* install-mac.sh says so when no dmg matches, instead of exiting silently ([bda881d](https://github.com/go7studio/Go7-Workhorse/commit/bda881d47d97f1de7ae75d2f78ad9cc8111c0617))
...
* judge every sed, awk, rg and sort flag that can write or run ([710d1d0](https://github.com/go7studio/Go7-Workhorse/commit/710d1d0b9135be1be2b9ca5a331d588fc34ad059))
...
* learning redaction catches the keys people actually paste ([f52e959](https://github.com/go7studio/Go7-Workhorse/commit/f52e9595fe63dbeb58e4d2c3fba64742e02722eb))
* Link install judges only its own entry for a bearer token ([b311296](https://github.com/go7studio/Go7-Workhorse/commit/b3112961532e6c0c4ce871ecf839746da3b68005))
...
* media create sends the template id the gate checked ([0455030](https://github.com/go7studio/Go7-Workhorse/commit/045503015d92eb01b186ec068539a289268eecac))
...
* moving a chat to another project takes its workers along ([0c4553b](https://github.com/go7studio/Go7-Workhorse/commit/0c4553b70989bca69dc06b2a052bacde02d03cb0))
...
* never seat the plan auditor on Grok Bot ([4f08233](https://github.com/go7studio/Go7-Workhorse/commit/4f08233a5314223becdf52198d16fafd17207919))
...
* New chat never takes over or drops a worker ([fbd3a4e](https://github.com/go7studio/Go7-Workhorse/commit/fbd3a4e1f1bfb8c8ce2a909714062e93af455cac))
* npm run try installs the pack it just made for this Mac ([d1d423f](https://github.com/go7studio/Go7-Workhorse/commit/d1d423fc68fd23a5c054a6a464511720bcfa793d))
* offline create_project refuses a state file it cannot read ([dd50ac4](https://github.com/go7studio/Go7-Workhorse/commit/dd50ac434d7d4adc38cbce4603f62b42ee053b9b))
...
* peer inbox files land whole and stay owner-only ([c21e8db](https://github.com/go7studio/Go7-Workhorse/commit/c21e8db5010e75d4a163e41d2d5a345b10def56e))
...
* read the Windows persisted PATH once per half minute, not per child ([d4e8ed0](https://github.com/go7studio/Go7-Workhorse/commit/d4e8ed02b10f0bb35bffaa74ee652a49549575c9))
...
* resend to a new model starts a fresh turn at zero ([#338](https://github.com/go7studio/Go7-Workhorse/issues/338)) ([d7ebf43](https://github.com/go7studio/Go7-Workhorse/commit/d7ebf43b9f9a9e4ca5d5c99e4446432c323b4f24))
...
* skill export stays in its folder, and installs ship the desk's skills ([915de3b](https://github.com/go7studio/Go7-Workhorse/commit/915de3bd5ce9d5fff63362c7fa86967a148bf285))
...
* Stop ends the rest of a custom tool batch ([b369b1f](https://github.com/go7studio/Go7-Workhorse/commit/b369b1f826966af7bc9e7ba33dea8c14890220ad))
...
* Stop on one custom chat leaves other chats' permission cards open ([34c4163](https://github.com/go7studio/Go7-Workhorse/commit/34c4163ce892d89173299883f2071b41b52b65e6))
...
* stopping a vendor that already exited no longer signals its old pid ([1f63441](https://github.com/go7studio/Go7-Workhorse/commit/1f63441c2a25640c68384506e83321672b7365fa))
* stopping a worker also stops one waiting on a card ([8c16dbc](https://github.com/go7studio/Go7-Workhorse/commit/8c16dbce6a06f563986c083b85f34f4b4e9a2fc2))
* switching a Cursor chat's model or access stops its running turn ([aa83d1b](https://github.com/go7studio/Go7-Workhorse/commit/aa83d1b215f6c33657d65c6a2437a6389e75de94))
* the Claude usage read gives up on a server that stops answering ([05aa47c](https://github.com/go7studio/Go7-Workhorse/commit/05aa47c7813cd00ef605f6c4b398c8dc0eb1aeff))
* the Cursor login copy is made in a private temp folder ([2026656](https://github.com/go7studio/Go7-Workhorse/commit/2026656de5935d1ea17d0059ac7d27ccc2d9dd81))
* the desk bridge checks the token before it parses anything ([80b3edc](https://github.com/go7studio/Go7-Workhorse/commit/80b3edcf1381d74efd4467d05b439873ae251fa0))
...
* the Grok Bot shim listens on the port its row names ([54be638](https://github.com/go7studio/Go7-Workhorse/commit/54be638991d8a8e55bb5d0966d1e2723e8d9912f))
* the list of rescues resume trusts is flushed before its ref exists ([3734471](https://github.com/go7studio/Go7-Workhorse/commit/3734471bb34917d8aeee500e9fd604e7247201bb))
...
* the read-only judge reads each word the way the shell hands it over ([55f3a6a](https://github.com/go7studio/Go7-Workhorse/commit/55f3a6a63d977b2c8a7514ed16c9b6682840c01c))
* the release gate runs on Windows, and a mac release must be signed ([20934a2](https://github.com/go7studio/Go7-Workhorse/commit/20934a2950341c2eaf01ce84e6968aa3c4fb1d8a))
* the report join says those are all the workers the wave started ([aa89c3d](https://github.com/go7studio/Go7-Workhorse/commit/aa89c3d69c347be49bb6437513a43814c8560494))
...
* the review's file baselines stay bounded and are written on a delay ([9abb2db](https://github.com/go7studio/Go7-Workhorse/commit/9abb2db0b3124ba06252369e66ba836bbdea6ff8))
* the signed desk no longer honours DYLD_* variables ([f373c58](https://github.com/go7studio/Go7-Workhorse/commit/f373c588205215edcc72b0789b16fbc22c96378e))
* the source-checkout update runs npm.cmd through cmd.exe on Windows ([c0d2398](https://github.com/go7studio/Go7-Workhorse/commit/c0d2398c66a3bd0958ebbd2c090cf7eb3b447655))
...
* the Workshop breakout no longer runs a second desk ([6aafcc9](https://github.com/go7studio/Go7-Workhorse/commit/6aafcc98517e12469774faac412dec2866e92eaf))
...
* third-party notices list what the installer ships, on any machine ([187af29](https://github.com/go7studio/Go7-Workhorse/commit/187af2911359d5d8c1d93d7236f1864c8c55638d))
...
* token counts and reset times round into the next unit at a boundary ([bf91b5a](https://github.com/go7studio/Go7-Workhorse/commit/bf91b5a56b5442de572411f1e80ae584c8753dea))
...
* two asks for one worker's folder no longer rebuild it at once ([4098f1f](https://github.com/go7studio/Go7-Workhorse/commit/4098f1f654873ed64ab5bdc27d730728e8d11905))
* two chats never share one export file ([3f2fdde](https://github.com/go7studio/Go7-Workhorse/commit/3f2fdde23b2b8d2e4a06740f9d0248b5b3b8e9ac))
...
* unclosed brackets, stray ask tags and filler runs parse in linear time ([f035b5f](https://github.com/go7studio/Go7-Workhorse/commit/f035b5fa3276312d363a3c67c720eaa1fe4512a0))
...
* **vendors:** no child the desk starts inherits the desk's environment ([9cca412](https://github.com/go7studio/Go7-Workhorse/commit/9cca41299a9e20d9437501b5ddbb27e24dec73ee))
...
* worker folders cut from a bare repository can be let go ([9e80449](https://github.com/go7studio/Go7-Workhorse/commit/9e804497374c89164de5e02ffa913def7a06e847))
...
* **workshop:** scrub pack-id wording from catalog pin comment ([03bf2e2](https://github.com/go7studio/Go7-Workhorse/commit/03bf2e274dc80a73c1774b3479e21edaab46ab80))
