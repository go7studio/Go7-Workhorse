export const WORKHORSE_SESSION_RULES =
  ...
  "Workhorse ships desk, setup, and ship-go7-godot-play skills. Load the exact matching skill with workhorse_list_skills then workhorse_read_skill before that work. " +
