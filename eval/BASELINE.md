...
Required skills now resolve to exact catalog entries and SKILL.md paths before dispatch; free-form expertise is stored separately as capabilities. A skill-gated task rejects adapter-only or mock-only completion.
