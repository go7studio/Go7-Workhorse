...
4. Live watch appears on the desk Workshop rail (collapsed strip → expand). When no pack is On, the rail shows a thin Add packs stub (Manage packs sheet, Available-first). Optional Detach opens the breakout window. Manage sheet and Settings → Workshop share one `WorkshopBlock`.
