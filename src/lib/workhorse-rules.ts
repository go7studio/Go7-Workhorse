...
const GROK_BOT_SPAWN_LAW =
  "Grok 4.6 is ACP Grok or Cursor Grok, never Grok Bot. Do not spawn grok-bot as a worker, builder, or auditor even when canCall is true. Grok Bot may call, analyze, and dispatch only. Naming Grok or Grok Build locks provider grok. Naming Cursor Grok locks Cursor. Naming grok-4.6 with no vendor lets the desk pick by leftover. Never the grok-bot custom slot. ";
