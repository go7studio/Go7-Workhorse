...
Desk skills include Grok, Codex, Claude, and **Workhorse** (`desk`, `setup`, `dgx-spark`). Spark / Qwen login is `dgx-spark`, not this skill. Leftover-meter wiring for a new vendor lives in the private skills hub (`vendor-meter`), not this public repo.
