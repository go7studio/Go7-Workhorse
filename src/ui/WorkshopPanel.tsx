...
/**
 * Workshop as a chat basic, beside Review and Terminal. A right-hand pane that paints the packs
 * that are On and opens the same install/grant block when none are — so a pack can be turned on
 * where it is wanted instead of in another section.
 *
