...
test("drop-to-chat and FileViewer stay; unused chrome and walks are gone", () => {
  ...
  assert.match(commands, /Profile, connected LLMs, skills, workshop, bot knowledge, routing, learning, usage, watch/i);
  const agents = readFileSync(path.join(ROOT, "AGENTS.md"), "utf8");
  assert.match(agents, /Profile, connected LLMs, skills, workshop, bot knowledge, routing, learning, usage, watch/i);
