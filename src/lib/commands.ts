...
export const COMMANDS: Command[] = [
  ...
  { id: "demo-mission", name: "/demo-mission", hint: "Show a sample mission board", run: "demo-mission" },
  { id: "theme", name: "/theme", hint: "Cycle light, dark, Workhorse, system", run: "theme", aliases: ["/t"] },
  { id: "settings", name: "/settings", hint: "Profile, connected LLMs, skills, workshop, routing, learning, usage, watch", run: "settings", aliases: ["/config", "/preferences", "/prefs"] },
