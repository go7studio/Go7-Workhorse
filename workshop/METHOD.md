...
4. Live watch appears on the desk Workshop rail (collapsed strip → expand) only after Turn on. When no pack is On, the rail is hidden — Install and Turn on live in Settings → Workshop only. Optional Detach opens the breakout window. Manage sheet and Settings → Workshop share one `WorkshopBlock`.
